...
if(existsSync(ssrEntry)){
  ...
  check('portfolio hides advanced operational navigation',!portfolioHtml.includes('href="/operations"')&&!portfolioHtml.includes('href="/logs"')&&!portfolioHtml.includes('href="/snapshots"')&&!portfolioHtml.includes('href="/risk"'));
